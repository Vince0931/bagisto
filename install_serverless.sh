...
aws s3 sync public/ s3://assets.web-id.fr --delete
aws s3 sync public/vendor/nova s3://assets.web-id.fr/nova
...
vendor/bin/bref cli --region eu-west-3 webid-lambda-dev-website
vendor/bin/bref cli --region eu-west-3 webid-lambda2-dev-artisan -- migrate
